...
import hydrograph.engine.spark.components.InputFileCsvUnivocityComponent
...
/**
  ...
  *
  */
class InputFileCsvUnivocityAdapter(typeBaseComponent: TypeBaseComponent) extends InputAdapterBase{

  private var inputFileDelimited:InputFileDelimitedEntityGenerator=null
  private var sparkIFileDelimitedComponent:InputFileCsvUnivocityComponent=null
  ...
  override def createComponent(baseComponentParams: BaseComponentParams): Unit = {
    sparkIFileDelimitedComponent= new InputFileCsvUnivocityComponent(inputFileDelimited.getEntity,
      baseComponentParams)
  }
