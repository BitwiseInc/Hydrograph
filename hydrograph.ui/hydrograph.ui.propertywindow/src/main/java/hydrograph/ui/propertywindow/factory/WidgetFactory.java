...
public class WidgetFactory {
	...
	public enum Widgets{
		...
		INPUT_ADDITIONAL_PARAMETERS_WIDGET(InputAdditionalParametersWidget.class, WidgetHelper.INSTANCE.getRunTimeWidgetConfig(Constants.ADDITIONAL_PARAMETERS_FOR_DB_LABEL,Constants.ADDITIONAL_PARAMETERS_FOR_DB_WINDOW_LABEL)),
		OUTPUT_ADDITIONAL_PARAMETERS_WIDGET(OutputAdditionalParametersWidget.class, WidgetHelper.INSTANCE.getRunTimeWidgetConfig(Constants.ADDITIONAL_PARAMETERS_FOR_DB_LABEL,Constants.ADDITIONAL_PARAMETERS_FOR_DB_WINDOW_LABEL)),
