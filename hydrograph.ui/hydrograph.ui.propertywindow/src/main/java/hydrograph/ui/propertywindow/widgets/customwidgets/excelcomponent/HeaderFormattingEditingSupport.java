...
/**
 * HeaderFormattingEditingSupport provides editing support for Header Format Column
 * @author Bitwise
 *
 */
public class HeaderFormattingEditingSupport extends EditingSupport{
	
	private CellEditor editor;
	private TableViewer viewer;
	private PropertyDialogButtonBar propDialogButtonBar;
	
	public HeaderFormattingEditingSupport(TableViewer viewer, PropertyDialogButtonBar propDialogButtonBar) {
		super(viewer);
	...
	protected Object getValue(Object element) {
		...
		if(excelConfigurationDataStructure !=null){
			return excelConfigurationDataStructure.getHeaderMap();
		}
		return "";
	}
	...
	protected void setValue(Object element, Object value) {
		ExcelConfigurationDataStructure excelConfigurationDataStructure = (ExcelConfigurationDataStructure)element;
		excelConfigurationDataStructure.setHeaderMap((Map<String,String>)value);
